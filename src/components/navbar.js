        ...
        <div className="w-full sticky top-0 h-24 p-6 z-40">
            ...
            <nav className="flex items-center justify-evenly gap-1 bg-transparent backdrop-blur-lg rounded-xl rounded-t-none h-12 w-full shadow-lg pl-3 md:pl-8 pr-2">
                ...
                <div className="w-fit h-fit mb-2 relative">
                    <a href="#projects" className="custom-transition text-lg tracking-normal hover:tracking-wide text-slate-800 md:text-xl font-medium" onMouseEnter={() => setIsProjectLineShown(true)} onMouseLeave={() => setIsProjectLineShown(false)}>projects</a>
                ...
                <div className="w-fit h-fit mb-2 relative">
                    <a href="#tech" className="custom-transition text-lg tracking-normal hover:tracking-wide text-slate-800 md:text-xl font-medium" onMouseEnter={() => setIsTechLineShown(true)} onMouseLeave={() => setIsTechLineShown(false)}>tech i use</a>
